...
public class TimeUtil {
    ...
    public static String formatDateDiffWithSeconds(long seconds, boolean shrink) {
        long future = System.currentTimeMillis() + (seconds * 1000);
        return formatDateDiff(future, shrink);
    }

    public static String formatDateDiff(long date, boolean shrink) {
        Calendar c = new GregorianCalendar();
        c.setTimeInMillis(date);
        Calendar now = new GregorianCalendar();
        return formatDateDiff(now, c, shrink);
    }

    public static String formatDateDiff(Calendar fromDate, Calendar toDate, boolean shrink) {
        ...
        String[] names = getPeriodNames(shrink);
        int accuracy = 0;
